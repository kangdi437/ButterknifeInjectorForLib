...
import com.jk.kangdi.butterknife.ButterKnife8;
import com.jk.kangdi.butterknife.ButterKnifeFactory;
import com.jk.kangdi.butterknife.IButterKnife;
import com.jk.kangdi.common.Definitions;
import com.jk.kangdi.common.Utils;
...
//            generateInjects(butterKnife);
    ...
    private void generateSingleClickMethod() {
        ...
        for (Element element : mElements) {
            if (element.isClick) {
                fullId = element.getFullID();
                method.append("\""+fullId+"\"" + ")");
            }
        }
        method.append("public void onClick(android.view.View v) {\n" +
                "int id = v.getId();\n" +
                "if (id == " + fullId + ") {\n\n" +
                "}" +
                "}");
        ...
        for (int i = 0; i < mElements.size() ;i++) {
            ...
            if (element.isClick) {
                if (i == 0) {
                    ...
                    method.append("else if (id == " + element.getFullID() + "){\n\n}");
                }
            }
        }
        method.append("}");
